...
class alluse():
    ...
    def normalandemergency_averagewaittime():
        ...
        print("门诊患者平均等待时间为%f" % (normal_averagewaittime_results))
        ...
        print("急诊患者平均等待时间为%f" % (emergency_averagewaittime_results))
        ...
        print("急诊一般患者平均等待时间为%f" % (emergency_general_averagewaittime_results))
        ...
        print("急诊严重患者平均等待时间为%f" % (emergency_serious_averagewaittime_results))
        ...
        print("急诊危重患者平均等待时间为%f" % (emergency_critical_averagewaittime_results))
        db.close()  # 最后关闭连接
